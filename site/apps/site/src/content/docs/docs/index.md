---
title: Documentation
description: MechCrate documentation — install and first project, the mx framework, the AI layer, the techniques corpus, and project notes.
---

The MechCrate docs are organised into five sections, mirrored by the sidebar:

- **Start** — install, first project, the folder contract, CLI reference.
- **Framework** — router, recipes, compose &amp; env conventions, infra credentials, upgrade, testing, Cloudflare deploy, remote blueprints.
- **AI Layer** — MCP server and tool families, the techniques corpus / RAG setup, the research pipeline, agent execution rules.
